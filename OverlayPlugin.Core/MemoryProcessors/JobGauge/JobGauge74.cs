...
{
    interface IJobGaugeMemory74 : IJobGaugeMemory { }

    partial class JobGaugeMemory74 : JobGaugeMemory, IJobGaugeMemory74
    {
        private static string jobDataSignature = "488D0D????????0F95C2E8????????488B8D";
        private static int jobDataSignatureOffset = -15;

        public JobGaugeMemory74(TinyIoCContainer container)
