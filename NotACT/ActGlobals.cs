namespace Advanced_Combat_Tracker {
	public static partial class ActGlobals {
		private static ActLocalization.LocalizationStringsHelper? _trans = null;

        internal static ActLocalization.LocalizationStringsHelper Trans => _trans ??= new ActLocalization.LocalizationStringsHelper();
